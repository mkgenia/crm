...
export interface Modulo {
  ...
  descripcion: string
  /**
   * La sección todavía no existe: el permiso se guarda igual, pero no se cuenta
   * como algo que la persona pueda ver hoy. Sin esto, la ficha de un agente
   * decía "9 de 13 secciones" contando cinco pantallas que no se han escrito.
   * Es la misma marca que usa el menú lateral para no pintarlas.
   */
...
export const MODULOS: Modulo[] = [
  ...
  { key: "reactivacion", grupo: "Generador de leads", label: "Reactivación", descripcion: "Recuperación de contactos antiguos" , enDesarrollo: true },
  { key: "galeria_rrss", grupo: "Generador de leads", label: "Galería RRSS", descripcion: "Piezas para redes sociales" , enDesarrollo: true },
  { key: "galeria_qr",   grupo: "Generador de leads", label: "Galería QR",   descripcion: "Códigos QR de escaparate y cartelería" , enDesarrollo: true },
  { key: "landings",     grupo: "Generador de leads", label: "Landings",     descripcion: "Páginas de captación" , enDesarrollo: true },
  { key: "leads",        grupo: "Inmobiliaria",       label: "Leads y contactos", descripcion: "Quien ha preguntado algo, y quien ya es contacto" },
  { key: "propiedades",  grupo: "Inmobiliaria",       label: "Propiedades",  descripcion: "Cartera de inmuebles" , enDesarrollo: true },
  ...
  { key: "matches",      grupo: "Inmobiliaria",       label: "Matches",      descripcion: "Cruce entre demandas y cartera" , enDesarrollo: true },
